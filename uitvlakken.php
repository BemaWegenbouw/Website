...
<div class="container"id="Uitvlakken">
    <h2 class="text-center"><?php echo(lang('uitvlakken_column1_title')); ?></h2><br>
    <div class="row">
        ...
        <div class="col-sm-8 col-md-8" style="background-color:pink;">
            <p><strong><?php echo(lang('uitvlakken_column1_head')); ?></strong></p>
            <p><?php echo(lang('uitvlakken_column1_text1')); ?></p>
        </div>
    </div>
</div>
</div>
